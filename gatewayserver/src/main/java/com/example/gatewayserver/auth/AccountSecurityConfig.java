...
public class AccountSecurityConfig {
    private final String idProject = "tw-andrei";
    ...
    public SecurityWebFilterChain mainSecurityFilterChain(ServerHttpSecurity http) {
        http
                ...
                .authorizeExchange(exchange -> exchange
                        ...
                        // vize 3
                        .pathMatchers(HttpMethod.GET, "/banking/transactions/get_with_account_details/**").hasAnyRole("ADMIN","CUSTOMER")
                        .pathMatchers(HttpMethod.POST, "/banking/transactions/create_with_account_details").hasAnyRole("ADMIN", "CUSTOMER")
                        .pathMatchers(HttpMethod.POST, "/banking/transactions/create_with_notification").hasAnyRole("ADMIN", "CUSTOMER")
